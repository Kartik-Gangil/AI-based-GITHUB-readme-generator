...
function Main() {
    ...
    //     try {
    //         axios.get('https://ai-based-github-readme-generator-production-a1ec.up.railway.app/auth/me', {
    ...
    const handelGenerate = async () => {
        setLoader(true)
        const response = await axios.post('https://ai-based-github-readme-generator-production-a1ec.up.railway.app/', {
            url: url
        })
    ...
    const handelDownload = async () => {
        await axios.post('https://ai-based-github-readme-generator-production-a1ec.up.railway.app/getReadme',
